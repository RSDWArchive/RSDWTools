...
(function () {
  ...
  var LANDING_CARDS = TOOLS.concat([
    ...
    {
      id: "rsdw-base-builder",
      name: "RSDWBaseBuilder",
      desc: "Create Bases in your Browser or in Blender",
      href: "https://rsdwbasebuilder.com/",
      icon: "/shared/assets/tool-icons/rsdw_base_builder.png",
      external: true,
    },
    {
      id: "rsdw-builds",
    ...
    },
    {
      id: "rsdw-model",
      name: "RSDWModel",
      desc: "Search and preview RuneScape: Dragonwilds models.",
      href: "https://rsdwmodel.com/",
      icon: "/shared/assets/tool-icons/rsdw_model.png",
      external: true,
    },
    {
      id: "dev-kit",
      name: "RSDWDevKit",
      desc: "Unlock Everything, Create Anything.",
